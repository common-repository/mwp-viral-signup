<?php
global $wpdb;
$table_wow_signup = $wpdb->prefix . "mwp_signup_free";
...
?>
<div class="wow">
<h1><?php esc_attr_e("Wow Viral Signups", "wow-marketings") ?></h1>
<ul class="wow-admin-menu">
<li><a href='admin.php?page=wow-signup-free'><?php esc_attr_e("List", "wow-marketings") ?></a></li>	
	<li>
	<?php if($count<2){?>
	<a href='admin.php?page=wow-signup-free&wow=add' ><?php esc_attr_e("Add new", "wow-marketings") ?></a>
	<?php } ?>
	</li>	
	<li><a href='admin.php?page=wow-signup-free&wow=signed'><?php esc_attr_e("Signed-up Users", "wow-marketings") ?></a></li>	
	<li><a href='https://wow-estore.com/en/wow-viral-signups-pro/' target="_blank"><b><?php esc_attr_e("Get Pro version", "wow-marketings") ?></b></a></li>
	<li><a href='admin.php?page=wow-signup-free&wow=items'><b><?php esc_attr_e("Free Plugins", "wow-marketings") ?></b></a></li>
	<li><a href='admin.php?page=wow-signup-free&wow=discount'><?php esc_attr_e("Get Discount", "wow-marketings") ?></a></li>
